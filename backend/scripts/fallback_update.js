...
const KITAB_UPDATES = [
    ...
    { id: '2', ar: 'كتاب صِلَةِ الرَّحِمِ', th: 'หมวดว่าด้วยการเชื่อมสัมพันธ์เครือญาติ' },
    ...
    { id: '12', ar: 'كتاب الِانْبِسَاطِ إِلَى النَّاسِ', th: 'หมวดว่าด้วยความยิ้มแย้มแจ่มใสต่อผู้คน' },
    ...
    { id: '17', ar: 'كتاب الزِّيَارَةِ', th: 'หมวดว่าด้วยการเยี่ยมเยียน' },
    { id: '18', ar: 'كتاب الأكَابِرِ', th: 'หมวดว่าด้วยผู้อาวุโส' },
    { id: '19', ar: 'كتاب الصَّغِيرِ', th: 'หมวดว่าด้วยเด็กเล็ก' },
    ...
    { id: '24', ar: 'كتاب السِّبَابِ', th: 'หมวดว่าด้วยการด่าทอ / การดูถูก' },
    { id: '25', ar: 'كتاب السَّرَفِ فِي الْبِنَاءِ', th: 'หมวดว่าด้วยความฟุ่มเฟือยในการก่อสร้าง' },
    { id: '26', ar: 'كتاب الرِّفْقِ', th: 'หมวดว่าด้วยความอ่อนโยน' },
    { id: '27', ar: 'كتاب الاعتناء بالدنيا', th: 'หมวดว่าด้วยการเอาใจใส่ต่อโลกดุนยา (ทางโลก)' },
    { id: '28', ar: 'كتاب الظُّلْم', th: 'หมวดว่าด้วยความอธรรม (การกดขี่)' },
    ...
    { id: '42', ar: 'كتاب السَّلامِ', th: 'หมวดว่าด้วยการทักทาย (การให้สลาม)' },
    ...
    { id: '45', ar: 'كتاب الرَّسَائِلِ', th: 'หมวดว่าด้วยจดหมาย / สาร' },
...
async function run() {
    ...
    console.log(`Processing ${KITAB_UPDATES.length} updates...`);

    let totalUpdated = 0;
    for (const update of KITAB_UPDATES) {
        const res = await collection.updateMany(
            { hadith_book: 'adab', 'kitab.ar': update.ar },
            { $set: { 'kitab.th': update.th, 'kitab.id': update.id } }
        );
        // Only log if something happened or randomly to save I/O
        if (res.modifiedCount > 0) {
            console.log(`Updated ${update.id} (${update.ar}): ${res.modifiedCount} docs`);
        }

...
# An-Nasai JSON URL
JSON_URL = "https://raw.githubusercontent.com/fawazahmed0/hadith-api/refs/heads/1/editions/ara-nasai.json"
...
def import_nasai():
    ...
    for h in hadiths:
        try:
            ...
            doc = {
                ...
                "kitab": {
                    "ar": "",  # Arabic section name not available in this source
    ...
    print(f"\nTotal An-Nasai in DB: {translations_collection.count_documents({'hadith_book': 'nasai'})}")

...
def translate_darimi_hadiths():
    """Translate all pending Sunan ad-Darimi hadiths (سنن الدارمي)"""
    ...
    print(f"📚 Found {total_pending} pending Darimi hadiths to translate")
    ...
    print(f"\n=== 🎉 Translation Complete (Sunan ad-Darimi) ===")
    print(f"✅ Translated: {translated_count}")
    print(f"❌ Errors: {error_count}")

if __name__ == "__main__":
    translate_darimi_hadiths()

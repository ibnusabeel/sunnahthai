...
# Configure Gemini - Uses KEY 1 for parallel processing
...
def translate_ibnmajah_hadiths():
    """Translate all pending Ibn Majah hadiths (سنن ابن ماجه)"""
    ...
    print(f"🌙 Found {total_pending} pending Ibn Majah hadiths to translate")
    ...
    print(f"\n=== 🎉 Translation Complete (Ibn Majah) ===")
    print(f"✅ Translated: {translated_count}")
    print(f"❌ Errors: {error_count}")

if __name__ == "__main__":
    translate_ibnmajah_hadiths()
